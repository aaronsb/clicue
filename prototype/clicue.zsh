...
typeset -g  _clicue_rmode=frecency   # active ranking metric
typeset -gi _clicue_rscore=0         # score for the candidate being ranked
typeset -gi _clicue_rw=1             # its recency multiplier
