...
_clicue_load() {
  ...
  typeset -gA CLICUE_GLOSS CLICUE_KIND CLICUE_FREQ CLICUE_ARGS CLICUE_ARGN \
              ...
              CLICUE_INVOKE_DISP CLICUE_PATHISH
...
_clicue_corpus_stamp() {
  local -a st st2
  # v2 adds CLICUE_LAST (per-command recency); v3 adds CLICUE_PATHISH and
  # CLICUE_INVOKE_DISP, and re-keys CLICUE_INVOKE canonically — a v2 cache read as v3
  # would rank invocations against keys that no longer exist.
